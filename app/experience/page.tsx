			...
			<div className="container">
				...
				>
					...
					<motion.p
						...
						className="text-lg text-muted-foreground mb-12 leading-8"
					>
						Hands-on experience building full-stack applications,
						backend systems, and AI-assisted engineering solutions
						through academic and personal development projects.
					</motion.p>
